...
export default class Board extends Component{
    ...
    const game = (await axios.get(`/api/games/${this.props.match.params.id}`)).data
      if (!game.active) {
    ...
    getOpponent = async () => {
        let game = (await axios.get(`/api/games/${this.props.match.params.id}`)).data
    ...
    getPlayerUserName = async (userId) => {
        return (await axios.get(`/api/users/users/${userId}`)).data.username
    }
